...
exports.Message = exports.Profile = exports.User = exports.db = void 0;
var bcrypt_1 = require("bcrypt");
var sequelize_1 = require("sequelize");
var pguser = process.env.PGUSER;
var pghost = process.env.PGHOST;
var pgpass = process.env.PGPASSWORD;
var pgdatabase = process.env.PGDATABASE;
var pgport = process.env.PGPORT;
var connstring = "postgres://".concat(pguser, ":").concat(pgpass, "@").concat(pghost, ":").concat(pgport, "/").concat(pgdatabase);
exports.db = new sequelize_1.Sequelize(connstring);
...
exports.Profile = exports.db.define('profiles', {
    name: {
        type: sequelize_1.DataTypes.STRING,
        allowNull: false,
        unique: true
...
exports.Message = exports.db.define('profiles', {
    message_text: {
        type: sequelize_1.DataTypes.STRING,
        allowNull: false
    },
